...
int main(){
	...
	//Shoorter loop to traverse a vector of any Data type(Evem pointers)
	for(auto x: v){
		cout<<x<<"/n";

	}

	v.back()//Returns last element of a vector
	v.pop_back()//Removes the last element

	vector<int> v = {2,4,2,5,1};//Creating a vector of given numbers

	//Creating a vector with initial size and initial values for each element
...
***********************************************************************************************
	...
	//Strings
	/*
	Strings can be combined using the + symbol. The function
